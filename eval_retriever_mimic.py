...
# 配置文件路径
json_filename = "/home/user2/zzhData/Test/models/data/optimized_reports_with_OriLabel_20260511_045342.json"# 替换为你的JSON文件路径
dataset = "mimic_cxr"  # 根据实际数据集选择 "iu_xray" 或 "mimic_cxr"
...
with open(json_filename, 'r', encoding='utf-8') as f:
    ...
    for item in data_list:
        ...
        query_info = item["query_meta"]
        true_report = query_info["labels"]
        original_report = query_info["original_response"]
        # 提取优化后报告
